...
5. Dashboard endpoints return recent transactions, monthly category summaries, and anomalies.
6. The question endpoint answers common spending questions from SQL totals.
